...
class BaseTrainer(ABC):
    def __init__(
        ...
        if not from_lmdb:
            self.normalizer = dataset.get("normalizer_info", None)
        ...
        if self.config.get("dataset", None):
            ...
            if self.config.get("val_dataset", None):
                if self.from_lmdb:
                    ...
                    self.val_dataset = self.config["val_dataset"]
    ...
    def load_loss(self):
        ...
        self.loss_fn["value"] = self.config["optim"].get("loss_value", "mae")
