...
class Evaluator:
    task_metrics = {
        ...
        "regression": ["value_mae"],
        "classifcation": ["cross_entropy"],
    }
    ...
    def __init__(self, task=None):
        assert task in ["s2ef", "is2rs", "is2re", "regression", "classification"]
        self.task = task
...
def value_mae(prediction, target):
    return absolute_error(prediction["value"], target["value"])
